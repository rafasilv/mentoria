      ...
      >
        <Defs>
          ...
          <LinearGradient 
            ...
            x2="-422.91" 
            y2="7681.08" 
            gradientTransform="matrix(77.74, 0, 0, -77.74, 32953.71, 597136.9)" 
            gradientUnits="userSpaceOnUse"
          >
            <Stop offset="0" stopColor="#76bfad" />
            <Stop offset="0.1" stopColor="#70bead" />
            <Stop offset="0.23" stopColor="#5fbaad" />
            <Stop offset="0.39" stopColor="#44b4ae" />
            <Stop offset="0.45" stopColor="#37b1ae" />
            <Stop offset="0.63" stopColor="#20a8c2" />
            <Stop offset="0.86" stopColor="#099fd7" />
            <Stop offset="1" stopColor="#009cde" />
          </LinearGradient>
          
          <ClipPath id="clip-path-2">
            <Rect x="0" y="0" width="146.02" height="69.26" fill="none" />
          </ClipPath>
        </Defs>
        
        <G clipPath="url(#clip-path)">
          <Rect width="77.74" height="52.53" fill="url(#Gradiente_sem_nome_9)" />
        </G>
        
        <G clipPath="url(#clip-path-2)">
          <Path 
            d="M62.47,26.71a1.67,1.67,0,1,1,0-3.33h12.9a1.67,1.67,0,1,1,0,3.33Z" 
            transform="translate(-5.75 -4.64)" 
            fill="#00aee0" 
          />
          <Path 
            d="M62.47,33.16a1.67,1.67,0,1,1,0-3.33h12.9a1.67,1.67,0,1,1,0,3.33Z" 
            transform="translate(-5.75 -4.64)" 
            fill="#00aee0" 
          />
          <Path 
            d="M62.47,20.26a1.67,1.67,0,1,1,0-3.33h12.9a1.67,1.67,0,1,1,0,3.33Z" 
            transform="translate(-5.75 -4.64)" 
            fill="#00aee0" 
          />
